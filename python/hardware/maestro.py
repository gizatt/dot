...
class Controller:
    ...
    def __init__(self,ttyStr='/dev/ttyACM0',device=0x0c, timeout=1., baudrate=115200):
        # Open the command port
        self.usb = serial.Serial(ttyStr, timeout=timeout, baudrate=baudrate)
